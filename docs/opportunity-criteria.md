# OpportunityRadar Criteria

Audience: Schwarzman Scholars with a diverse mix of policy, consulting, technology, startups, investing, global business, public sector, international affairs, and leadership-track interests.

Prefer roles with one or more high-signal traits:
...
- Strategy, investing, product, AI, policy, public impact, frontier technology, China/global affairs, climate, infrastructure, or cross-border business angle.
...
- `90-100`: exceptional and should almost always make the digest.
- `80-89`: strong fit with clear Scholar-relevant signal.
- `70-79`: include if the week is thin or the city/company mix is useful.
- Below `70`: exclude.
